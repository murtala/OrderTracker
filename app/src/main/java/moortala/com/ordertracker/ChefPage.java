                    ...
                    try {
                        ...
                        if (inProgressSize > inProgressVal){
                            ...
                            if (canceledOrders.isEmpty()){
                                ...
                                scheduleNotification(getNotification("Canceled " + canceledOrders.toString()), 5, alarmManager2);
                            }

                        }else{
                            AlarmManager alarmManager3 =null;
                            scheduleNotification(getNotification(""), 3, alarmManager3);
                        }
                    ...
                    cm = new ConnectionManager(ChefPage.this, new Callback() {
                        ...
                        public void run(Object result) {
                            try {
                                ...
                                //change the text on the buttons depending on state of order
                                if (od.getStatus() == 5) {
